        	...
        	<div class="column">
                ...
                <div class="">
                                    <div class="support-form text-center">
                                      ...
                                      <span class='text-danger text-center'><strong>Successful!</strong>Message has been Sent.</span>
                                        <?php endif; ?>   
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215313542/domains/remedycodes.info/public_html/tracking1/resources/views/home/contact.blade.php ENDPATH**/ ?>