...
} elseif ($_instance->childHasBeenRendered('og2iC0M')) {
    $componentId = $_instance->getRenderedChildComponentId('og2iC0M');
    $componentTag = $_instance->getRenderedChildComponentTagName('og2iC0M');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('og2iC0M');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('og2iC0M', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH /home/u215313542/domains/remedycodes.site/public_html/pro/resources/views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>