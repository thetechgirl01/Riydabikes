                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="<?php echo e(route('admin.shipments.store')); ?>" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <h6 class="text-<?php echo e($text); ?>">Sender Address <span class="text-danger">*</span></h6>
                                    ...
                                    <div class="form-group col-md-6">
                                        <h6 class="text-<?php echo e($text); ?>">Origin Location <span class="text-danger">*</span></h6>
                                    ...
                                    <div class="form-group col-md-6">
                                        <h6 class="text-<?php echo e($text); ?>">Destination Location <span class="text-danger">*</span></h6>
                                    ...
                                    <div class="form-group col-md-12">
                                        <h6 class="text-<?php echo e($text); ?>">Receiver Address <span class="text-danger">*</span></h6>
                                    ...
                                    <div class="form-group col-md-6">
                                        <h6 class="text-<?php echo e($text); ?>">Dimensions (LxWxH)</h6>
                                        <input type="text" class="form-control bg-<?php echo e($bg); ?> text-<?php echo e($text); ?>" id="dimensions" name="dimensions" placeholder="e.g. 30x20x15 cm" value="<?php echo e(old('dimensions')); ?>">
                                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ship\resources\views/admin/create-shipment.blade.php ENDPATH**/ ?>