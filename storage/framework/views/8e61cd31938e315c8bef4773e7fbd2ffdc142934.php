                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="<?php echo e(route('admin.shipments.store')); ?>" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <h6 class="text-<?php echo e($text); ?>">Shipment Video <small class="text-muted">(Optional)</small></h6>
                                        <input type="file" class="form-control bg-<?php echo e($bg); ?> text-<?php echo e($text); ?>" name="video" accept="video/mp4,video/mpeg,video/quicktime,video/x-msvideo,video/webm">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/losideko/shypdirect.elitemaxpro.click/resources/views/admin/create-shipment.blade.php ENDPATH**/ ?>