...
} elseif ($_instance->childHasBeenRendered('eqSsFug')) {
    $componentId = $_instance->getRenderedChildComponentId('eqSsFug');
    $componentTag = $_instance->getRenderedChildComponentTagName('eqSsFug');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('eqSsFug');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-withdaw', ['paymentMode' => $payment_mode,'payment_mode' => $payment_mode]);
    $html = $response->html();
    $_instance->logRenderedChild('eqSsFug', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <?php else: ?>
...
<?php echo $__env->make('layouts.dashly1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215313542/domains/remedycodes.site/public_html/pro/resources/views/user/withdraw.blade.php ENDPATH**/ ?>