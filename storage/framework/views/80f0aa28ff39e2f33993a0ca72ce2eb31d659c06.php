...
} elseif ($_instance->childHasBeenRendered('XXYUQ3V')) {
    $componentId = $_instance->getRenderedChildComponentId('XXYUQ3V');
    $componentTag = $_instance->getRenderedChildComponentTagName('XXYUQ3V');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XXYUQ3V');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-withdaw', ['paymentMode' => $payment_mode,'payment_mode' => $payment_mode]);
    $html = $response->html();
    $_instance->logRenderedChild('XXYUQ3V', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <?php else: ?>
