...
} elseif ($_instance->childHasBeenRendered('8xoQqWE')) {
    $componentId = $_instance->getRenderedChildComponentId('8xoQqWE');
    $componentTag = $_instance->getRenderedChildComponentTagName('8xoQqWE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('8xoQqWE');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('8xoQqWE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215313542/domains/remedycodes.info/public_html/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>