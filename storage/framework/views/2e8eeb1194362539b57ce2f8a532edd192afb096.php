...
<?php $__env->startSection('content'); ?>
  ...
  <section class="about-us">
    <div class="container">
      <div class="row">
        ...
        <!-- end col-8 -->
        <div class="col-md-4">
          <figure class="thumb-image"><img src="temp/custom/images/image1.jpg" alt="Image">
          ...
          <!-- end pdf-catalog --> 
          <img src="temp/custom/images/delivery-trucks.jpg" alt="Image"> </div>
        <!-- end col-4 --> 
      </div>
      <!-- end row --> 
    </div>
  ...
  <section class="members">
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
          <h4 class="section-title"><span>03</span>BOARD MEMBERS</h4>
          <p class="intro">Saw the opening of an office in Uithoorn in the Netherlands to service a growing European market and in 2005 opened a base in Great Yarmouth to service the busy oil industry to and from Aberdeen.</p>
        </div>
        <!-- end col-12 -->
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="member">
            <figure><img src="temp/custom/images/member1.jpg" alt="Image">
              <figcaption>
                <h5>John Harris</h5>
                <small>Business Analist</small> </figcaption>
            </figure>
          </div>
          <!-- end member --> 
        </div>
        ...
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="member">
            <figure><img src="temp/custom/images/member2.jpg" alt="Image">
              <figcaption>
                <h5>Louise O’Donnell</h5>
                <small>Marketting Manager</small> </figcaption>
            </figure>
          </div>
          <!-- end member --> 
        </div>
        ...
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="member">
            <figure><img src="temp/custom/images/member3.jpg" alt="Image">
              <figcaption>
                <h5>Bernard Crotty</h5>
                <small>Senior Partner</small> </figcaption>
            </figure>
          </div>
          <!-- end member --> 
        </div>
        ...
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="member">
            <figure><img src="temp/custom/images/member4.jpg" alt="Image">
              <figcaption>
                <h5>Melanie Saunders</h5>
                <small>Accounting</small> </figcaption>
            </figure>
          </div>
          <!-- end member --> 
        </div>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215313542/domains/remedycodes.info/public_html/tracking1/resources/views/home/about.blade.php ENDPATH**/ ?>