...
} elseif ($_instance->childHasBeenRendered('gpeOjZp')) {
    $componentId = $_instance->getRenderedChildComponentId('gpeOjZp');
    $componentTag = $_instance->getRenderedChildComponentTagName('gpeOjZp');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('gpeOjZp');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('gpeOjZp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH /home/elitemaxpro/shypdirect.elitemaxpro.click/resources/views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>