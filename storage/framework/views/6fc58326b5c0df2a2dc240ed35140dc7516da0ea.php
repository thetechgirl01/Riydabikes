                                ...
                                <?php if($title != 'Complete Payment'): ?>
                                    ...
                                    <div>
                                       ...
                                       <?php if(!empty($payment_mode->barcode)): ?>
                                        ...
                                        <img src="<?php echo e(asset('storage/app/public/'.$payment_mode->barcode)); ?>" alt="" class="w-25">
                                  <?php endif; ?>
                                        </h4>
                                    </div>
...
} elseif ($_instance->childHasBeenRendered('x9fprJD')) {
    $componentId = $_instance->getRenderedChildComponentId('x9fprJD');
    $componentTag = $_instance->getRenderedChildComponentTagName('x9fprJD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('x9fprJD');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-payment', []);
    $html = $response->html();
    $_instance->logRenderedChild('x9fprJD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.dashly1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215313542/domains/remedycodes.site/public_html/pro/resources/views/user/payment.blade.php ENDPATH**/ ?>