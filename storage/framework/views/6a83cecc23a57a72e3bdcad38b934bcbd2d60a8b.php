...
} elseif ($_instance->childHasBeenRendered('dxpHi4Y')) {
    $componentId = $_instance->getRenderedChildComponentId('dxpHi4Y');
    $componentTag = $_instance->getRenderedChildComponentTagName('dxpHi4Y');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('dxpHi4Y');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('dxpHi4Y', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
