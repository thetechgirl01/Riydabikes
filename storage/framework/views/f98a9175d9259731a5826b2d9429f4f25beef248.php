...
<?php endif; ?>
                ...
                <div class="mt-2 mb-5 row">
                    <div class="col-12">
                        <di>
                            <a class='btn btn-primary' href='https://codesremedy.com/'>
                               Vist our website
                            </a>
                        </di>
...
} elseif ($_instance->childHasBeenRendered('ry6eksy')) {
    $componentId = $_instance->getRenderedChildComponentId('ry6eksy');
    $componentTag = $_instance->getRenderedChildComponentTagName('ry6eksy');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ry6eksy');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('ry6eksy', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elitemaxpro/shypdirect.elitemaxpro.click/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>