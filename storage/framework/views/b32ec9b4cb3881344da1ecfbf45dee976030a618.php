...
<?php $__env->startSection('title', 'Rental Receipt'); ?>
...
<div class="bg-gray-50 dark:bg-gray-900 min-h-screen">
    <div class="relative bg-gradient-to-r from-indigo-600 to-purple-700 py-10 px-4 sm:px-6 lg:px-8 text-white">
        <div class="max-w-4xl mx-auto">
            ...
            <p class="text-xl opacity-90">Thank you, <?php echo e($rental->guest_name); ?></p>
        </div>
    ...
    <div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden mb-8">
            <div class="border-b border-gray-200 dark:border-gray-700 px-6 py-4 flex items-center justify-between">
                <h2 class="text-xl font-semibold text-gray-800 dark:text-white">Booking <?php echo e($rental->rental_no); ?></h2>
            ...
            <div class="px-6 py-4 space-y-6 text-gray-700 dark:text-gray-300">
                ...
                <div class="flex items-center gap-4 pb-4 border-b dark:border-gray-700">
                    <img src="<?php echo e($rental->bike->image_url); ?>" alt="<?php echo e($rental->bike->name); ?>" class="w-20 h-20 object-cover rounded-md">
                    <div class="flex-1">
                        <p class="font-semibold text-gray-900 dark:text-white"><?php echo e($rental->bike->name); ?></p>
                        <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($rental->total_days); ?> day(s) × ₦<?php echo e(number_format($rental->daily_rate, 2)); ?></p>
                    </div>
                    <div class="text-right">
                        <p class="text-xl font-bold text-gray-900 dark:text-white">₦<?php echo e(number_format($rental->total_amount, 2)); ?></p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="font-medium"><?php echo e($rental->start_date->format('M d, Y')); ?></p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-500 dark:text-gray-400">End Date</p>
                        <p class="font-medium"><?php echo e($rental->end_date->format('M d, Y')); ?></p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-500 dark:text-gray-400">Payment Method</p>
                        <p class="font-medium"><?php echo e($rental->payment_method); ?></p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-500 dark:text-gray-400">Booked On</p>
                        <p class="font-medium"><?php echo e($rental->created_at->format('M d, Y h:i A')); ?></p>
                    </div>
                    <div class="md:col-span-2">
                        <p class="text-sm text-gray-500 dark:text-gray-400">Customer</p>
                        <p class="font-medium"><?php echo e($rental->guest_name); ?></p>
                        <p class="text-sm"><?php echo e($rental->guest_email); ?> · <?php echo e($rental->guest_phone); ?></p>
                    </div>
                    <?php if($rental->pickup_address): ?>
                        <div class="md:col-span-2">
                            <p class="text-sm text-gray-500 dark:text-gray-400">Pickup Address</p>
                            <p class="font-medium"><?php echo e($rental->pickup_address); ?></p>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="border-t dark:border-gray-700 pt-4">
                    <div class="flex justify-between text-lg font-bold">
                        <span>Total</span>
                        <span>₦<?php echo e(number_format($rental->total_amount, 2)); ?></span>
                    </div>
                </div>
        ...
        <div class="flex flex-col sm:flex-row gap-3">
            <a href="<?php echo e(route('home.bikes.index')); ?>" class="inline-flex justify-center items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-md text-sm font-medium">
                Browse More Bikes
            </a>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shypdirect\resources\views/home/bikes/rental-receipt.blade.php ENDPATH**/ ?>