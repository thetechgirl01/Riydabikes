...
<div class="bg-gray-50 min-h-screen py-12">
    ...
    <input type="number" step="0.1" min="0" id="weight_kg" name="weight_kg" value="<?php echo e(old('weight_kg', 0)); ?>" placeholder="e.g., 2.5" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:ring-2 focus:ring-[#800020] focus:border-transparent transition-all">
    <p class="text-xs text-gray-500 mt-1">First <?php echo e($pricingSettings->free_weight_kg); ?>kg is free; ₦<?php echo e(number_format($pricingSettings->per_kg_rate, 0)); ?>/kg above.</p>
</div>
                        <div>
    ...
    <label class="relative flex items-center p-4 border rounded-xl cursor-pointer transition-all <?php echo e($gatewayAvail['paystack'] ? 'hover:border-[#800020] has-[:checked]:border-[#800020] has-[:checked]:bg-[#800020]/5' : 'opacity-60 cursor-not-allowed'); ?>">
        <input type="radio" name="payment_method" value="Paystack" <?php echo e($gatewayAvail['paystack'] ? '' : 'disabled'); ?> class="payment-radio w-4 h-4 text-[#800020]">
        <div class="ml-3">
            <span class="block font-medium text-gray-800">Paystack</span>
            <span class="block text-xs <?php echo e($gatewayAvail['paystack'] ? 'text-gray-500' : 'text-amber-600'); ?>"><?php echo e($gatewayAvail['paystack'] ? 'Card / Bank / USSD' : 'Coming soon'); ?></span>
        </div>
    </label>

    <label class="relative flex items-center p-4 border rounded-xl cursor-pointer transition-all <?php echo e($gatewayAvail['flutterwave'] ? 'hover:border-[#800020] has-[:checked]:border-[#800020] has-[:checked]:bg-[#800020]/5' : 'opacity-60 cursor-not-allowed'); ?>">
        <input type="radio" name="payment_method" value="Flutterwave" <?php echo e($gatewayAvail['flutterwave'] ? '' : 'disabled'); ?> class="payment-radio w-4 h-4 text-[#800020]">
        <div class="ml-3">
            <span class="block font-medium text-gray-800">Flutterwave</span>
            <span class="block text-xs <?php echo e($gatewayAvail['flutterwave'] ? 'text-gray-500' : 'text-amber-600'); ?>"><?php echo e($gatewayAvail['flutterwave'] ? 'Card / Bank / USSD' : 'Coming soon'); ?></span>
        </div>
    </label>
</div>
                    </div>
