...
} elseif ($_instance->childHasBeenRendered('p9cKu0t')) {
    $componentId = $_instance->getRenderedChildComponentId('p9cKu0t');
    $componentTag = $_instance->getRenderedChildComponentTagName('p9cKu0t');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('p9cKu0t');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-payment', []);
    $html = $response->html();
    $_instance->logRenderedChild('p9cKu0t', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                <?php else: ?>
