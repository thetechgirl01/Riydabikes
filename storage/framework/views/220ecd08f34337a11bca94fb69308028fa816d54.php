...
By <?php echo e($settings->sit_name); ?> leading partners in custody, overcollateralized lending model, and secure-by-design infrastructure. </h2>
</div>
...
<?php echo e($settings->sit_name); ?> Works With the Leading Authorities in Custody and Compliance </h2>
</header> </div>
...
Bakkt is a trusted digital asset platform providing <?php echo e($settings->sit_name); ?> with Bitcoin and Ethereum custody in the Bakkt Warehouse, the company’s regulated custodian, which comprises both online (warm) and air-gapped (cold) digital asset storage to minimize risks. For extra protection, Bakkt’s wallets are covered by an insurance policy from a leading global carrier. </p>
<div class="mt-16">
...
BitGo </h3>
<p class="text-18 leading-135 text-color-500">
BitGo is the first Qualified Custodian purpose-built for digital assets and a long-standing <?php echo e($settings->sit_name); ?> partner, serving primarily the retail side of our business. Private keys entrusted to BitGo are held in military-grade Class III vaults and carry $100M in insurance protections. </p>
<div class="mt-16">
...
Armanino </h3>
<p class="text-18 leading-135 text-color-500">
As one of the leading accounting and business consulting firms in the US, Armanino is providing uninterrupted access to industry-standard attest reporting and a snapshot of <?php echo e($settings->sit_name); ?> total assets and liabilities, updated daily. </p>
<div class="mt-16">
...
Securitize </h3>
<p class="text-18 leading-135 text-color-500">
Securitize enables ownership, management, and trading of digital securities (security tokens). The company is an SEC Registered Transfer Agent and its DS protocol allows for tokenized securities to be staked as collateral for <?php echo e($settings->sit_name); ?> Instant Crypto Credit Lines™. </p>
<div class="mt-16">
...
<p class="text-18 leading-135 text-color-500">
<?php echo e($settings->sit_name); ?> is 256-bit SSL secured, thus employing one of the most solid encryption methods used in modern encryption algorithms, protocols, and technologies. </p>
</div>
<div ob-tabs-item>
<h3 class="mb-16 text-32 leading-115 font-medium text-color-800">
...
<p>Compliance with stringent regulations and global KYC and AML standards are testaments that security is <?php echo e($settings->sit_name); ?> utmost priority. That is why individuals, businesses, and institutions big and small trust <?php echo e($settings->sit_name); ?> with their data.</p>
<p><?php echo e($settings->sit_name); ?> is cultivating a community of security-savvy users and employees to strengthen the blockchain and crypto lending ecosystems. This includes running regular internal security &amp; privacy workshops to ensure that <?php echo e($settings->sit_name); ?> staff is up to speed with today’s cybersecurity matters.</p> </div>
</div>
...
What does <?php echo e($settings->sit_name); ?> being licensed and regulated mean? </a>
</p>
</div>
</div>
</section>
...
<p><?php echo e($settings->sit_name); ?> partners with the foremost providers of security in the blockchain space, including BitGo and Ledger Vault, among others. Collectively, they carry $375M in insurance protections for digital assets held on the <?php echo e($settings->sit_name); ?> platform via the most prestigious syndicates of underwriters.</p> </div>
<div class="mt-16">
...
<div class="s-text2 m-clip">
<p>To increase transparency, <?php echo e($settings->sit_name); ?> is working with Armanino to conduct a Proof of Reserves assessment and provide real-time attestations over the company’s custodial holdings. With this pioneering move for the crypto lending space, we give you the ultimate peace of mind that <?php echo e($settings->sit_name); ?> is able to meet client obligations at all times.</p> </div>
...
<div class="s-text2 m-clip">
<p><?php echo e($settings->sit_name); ?> uses Jumio to adhere to the strictest KYC and AML global compliance standards. Jumio is also trusted by Microsoft, Oracle, Monzo, and HSBC.</p> </div>
</div>
</div>
</div>
</section>
...
<p><?php echo e($settings->sit_name); ?> implements a variety of security measures when users enter, submit, or access their information.</p> </div>
</div>
</div>
</div>
</section>
...
<div class="s-text2 m-clip">
<p>ISO/IEC 27001 guarantees that <?php echo e($settings->sit_name); ?> security infrastructure is of the highest standard, thus ensuring the safety of the enterprise and minimizing risks for all clients and investors. Being ISO/IEC 27001 certified, <?php echo e($settings->sit_name); ?> is now raising the bar for the entire blockchain space, by utilizing the most rigorous security policies, impeccable risk assessment, data protection, and state-of-the-art cybersecurity.</p> </div>
<div class="mt-16">
...
<p>Open your <?php echo e($settings->sit_name); ?> account today and make your cryptocurrency work
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215313542/domains/remedycodes.info/public_html/resources/views/home/security.blade.php ENDPATH**/ ?>