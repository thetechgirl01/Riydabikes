...
} elseif ($_instance->childHasBeenRendered('gR9TDDR')) {
    $componentId = $_instance->getRenderedChildComponentId('gR9TDDR');
    $componentTag = $_instance->getRenderedChildComponentTagName('gR9TDDR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('gR9TDDR');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('gR9TDDR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shyp\resources\views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>