 ...
 <div id="Upgradeaccount" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header ">
                <h4 class="modal-title ">Add Account Upgrade to <?php echo e($user->name); ?> <?php echo e($user->l_name); ?> </h4>
                <button type="button" class="close " data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body ">
                <form role="form" method="post" action="<?php echo e(route('upgradeaccount')); ?>">
                    ...
                    <div class="form-group">
                        <h5 class=" ">Turn On/Off Account Upgrade</h5>
                        <select class="form-control  " name="upgrade">
                            <?php if($user->upgrade=='0'): ?>
                            <option value="" selected disabled>OFF</option>
                            <?php else: ?>
                            <option value="" selected disabled>ON</option>
                            <?php endif; ?>
                    ...
                    <div class="form-group">
                        <h5 class=" ">Select Investment Plan You want user to upgrade to</h5>
                        <select class="form-control  " name="upgradeplan">
                    ...
                    <div class="form-group">
                        <input type="submit" class="btn btn-primary" value="Add Upgrade">
                        <input type="hidden" name="user_id" value="<?php echo e($user->id); ?>">
                    </div>
                </form>
            </div>
...
<!-- send a single user email Modal-->
 ...
 <!-- /Delete user Modal -->
<?php /**PATH C:\xampp\htdocs\maindasily\resources\views/admin/Users/users_actions.blade.php ENDPATH**/ ?>