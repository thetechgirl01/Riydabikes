                            ...
                            <table id="ShipTable" class="table table-hover ">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $deposits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <?php if(isset($deposit->duser) && $deposit->duser): ?>
                                                    <?php echo e($deposit->duser->name); ?>

                                                <?php elseif(isset($deposit->guest_name)): ?>
                                                    <?php echo e($deposit->guest_name); ?> (Guest)
                                                <?php else: ?>
                                                    N/A
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php if(isset($deposit->duser) && $deposit->duser): ?>
                                                    <?php echo e($deposit->duser->email); ?>

                                                <?php elseif(isset($deposit->guest_email)): ?>
                                                    <?php echo e($deposit->guest_email); ?>
                                            ...
                                            <td>
                                                <?php if($deposit->created_at): ?>
                                                    <?php echo e($deposit->created_at->toDayDateTimeString()); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elitemaxpro/shypdirect.elitemaxpro.click/resources/views/admin/Deposits/mdeposits.blade.php ENDPATH**/ ?>