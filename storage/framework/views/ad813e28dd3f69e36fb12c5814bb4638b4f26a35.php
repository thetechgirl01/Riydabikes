                    ...
                    <div class="col-12">
                        ...
                        <div class="card p-md-5 p-2 shadow-lg ">
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item">
                                    <a href="#email" class="nav-link" data-toggle="tab">Email Settings</a>
                                </li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215313542/domains/remedycodes.info/public_html/tracking1/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>