...
<?php $__env->startSection('content'); ?>
    ...
    <div class="mb-5">
        <h1 class="h2 m-0">
         Upgrade  your  account to  <?php echo e($plan->name); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
    <div class="row mb-3 d-flex justify-content-center mt-15">
            ...
            <div class="col-xl-8">
                ...
                <div class="card border-0 py-6 px-4 mb-6 mb-xl-3">
                    <div class="card-body">
                        ...
                        <div class="">
                            <form method="post" action="<?php echo e(route('newdeposit')); ?>">
                                ...
                                <input type="number"  name="amount" value='<?php echo e($plan->price); ?>' placeholder="  <?php echo e($settings->currency); ?> <?php echo e($plan->min_price); ?> - <?php echo e($settings->currency); ?> <?php echo e($plan->max_price); ?> " class="form-control h3 "> <br>
                                ...
                                <input type="submit" class="btn btn-block pricing-action btn-primary" value="Continue Plan Upgrade " >
                            </form>
...
<?php echo $__env->make('layouts.dashly1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\maindasily\resources\views/user/upgrade.blade.php ENDPATH**/ ?>