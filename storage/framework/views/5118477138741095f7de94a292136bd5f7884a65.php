...
} elseif ($_instance->childHasBeenRendered('kCG0fzk')) {
    $componentId = $_instance->getRenderedChildComponentId('kCG0fzk');
    $componentTag = $_instance->getRenderedChildComponentTagName('kCG0fzk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('kCG0fzk');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('kCG0fzk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH C:\xampp\htdocs\shipping\resources\views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>