    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow p-8 text-center border border-gray-100">
                ...
                <a href="mailto:<?php echo e($settings->contact_email); ?>" class="text-lg font-medium text-primary-600 hover:underline"><?php echo e($settings->contact_email); ?></a>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow p-8 text-center border border-gray-100">
                ...
                <p class="text-lg font-medium text-primary-600"><?php echo e($settings->locations); ?></p>
            </div>
        </div>
    </div>
</section>
                ...
                <div id="location-map" class="h-80 md:h-96 w-full rounded-lg relative bg-blue-50 overflow-hidden">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center">
                        <div class="text-center p-6 bg-white bg-opacity-90 rounded-xl shadow-lg max-w-md transform hover:scale-105 transition-transform duration-300">
                            ...
                            <p class="text-primary-600 font-medium mb-2"><?php echo e($settings->site_name); ?></p>
                            <p class="text-gray-700"><?php echo e($settings->locations); ?></p>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elitemaxpro/shypdirect.elitemaxpro.click/resources/views/home/contact.blade.php ENDPATH**/ ?>