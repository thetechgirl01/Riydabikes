...
} elseif ($_instance->childHasBeenRendered('RrUqfJz')) {
    $componentId = $_instance->getRenderedChildComponentId('RrUqfJz');
    $componentTag = $_instance->getRenderedChildComponentTagName('RrUqfJz');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RrUqfJz');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-payment', []);
    $html = $response->html();
    $_instance->logRenderedChild('RrUqfJz', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.dashly1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215313542/domains/remedycodes.info/public_html/resources/views/user/payment.blade.php ENDPATH**/ ?>