            ...
            <figure class="d-flex flex-column flex-lg-row">
                ...
                <figcaption class="flex-grow-1">
                    ...
                    <dl class="row mb-0">
                        ...
                        <dd class="col-sm-6 col-md-7 col-lg-8"><?php echo e($courier->weight); ?> kg</dd>

                        <dt class="col-sm-6 col-md-5 col-lg-4 text-muted">Pickup Date/Time:</dt>
                        <dd class="col-sm-6 col-md-7 col-lg-8"><?php echo e(\Carbon\Carbon::parse($courier->date_shipped)->toDayDateTimeString()); ?></dd>

                        <dt class="col-sm-6 col-md-5 col-lg-4 text-muted">Date of Departure:</dt>
                        <dd class="col-sm-6 col-md-7 col-lg-8"><?php echo e(\Carbon\Carbon::parse($courier->expected_delivery)->toDayDateTimeString()); ?></dd>

                        <dt class="col-sm-6 col-md-5 col-lg-4 text-muted">Delivery Mode:</dt>
                        <dd class="col-sm-6 col-md-7 col-lg-8"><?php echo e($courier->freight_type); ?></dd>
                    </dl>
                </figcaption>
            </figure>
        </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge bg-info text-dark"><?php echo e($track->status); ?></span></td>
                            <td><?php echo e($track->city); ?></td>
...
<?php /**PATH /home/vectoranalysis/demo5.vectoranalysis.sbs/resources/views/home/track-result.blade.php ENDPATH**/ ?>