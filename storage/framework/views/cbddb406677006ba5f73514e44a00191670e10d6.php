...
} elseif ($_instance->childHasBeenRendered('gvuZHah')) {
    $componentId = $_instance->getRenderedChildComponentId('gvuZHah');
    $componentTag = $_instance->getRenderedChildComponentTagName('gvuZHah');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('gvuZHah');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-payment', []);
    $html = $response->html();
    $_instance->logRenderedChild('gvuZHah', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.dashly1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\maindasily\resources\views/user/payment.blade.php ENDPATH**/ ?>