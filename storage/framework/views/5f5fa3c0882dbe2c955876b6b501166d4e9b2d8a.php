...
<?php endif; ?>
            ...
            <?php if(Auth('admin')->User()->type == 'Super Admin' || Auth('admin')->User()->type == 'Admin'): ?>
                <div class="py-2 ml-md-auto py-md-0">
                    <a href="<?php echo e(route('createnewuser')); ?>" class="mr-2 btn btn-success d-lg-inline">Create New Shipment</a>
                    <a href="<?php echo e(route('manageusers')); ?>" class="mr-2 btn btn-danger d-lg-inline">Manage Shipment</a>
...
<?php echo $__env->make('layouts.app1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215313542/domains/remedycodes.info/public_html/tracking1/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>