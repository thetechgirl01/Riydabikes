                    ...
                    <div class="col-md-12">
                         <div>
                            <a class='btn btn-primary' href='https://wa.me/2348105831204'>
                                For help: Contact CrownaTech Support Team via WhatsApp
                            </a>
                        </div>
                                    ...
                                    <div class=" form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" aria-label="Hello" value="Hello" name="greet"
                                                class="form-control">
                                            <input type="text" aria-label="Investor"  name="title"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class=" form-group">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shypdirect\resources\views/admin/email/index.blade.php ENDPATH**/ ?>