<div class="row">
    <div class="col-md-12">
        <form action="javascript:void(0)" method="POST" id="gatewayform">
            ...
            <small>From <a href="https://dashboard.paystack.com" target="_blank">https://dashboard.paystack.com</a>. Set callback URL: <strong><?php echo e($settings->site_address); ?>/dashboard/paystackcallback</strong></small>
            ...
            <div class="form-group">
                <h5>Paystack URL</h5>
                <input type="text" name="paystack_url" class="form-control" value="<?php echo e($paystack->paystack_url); ?>" readonly>
            </div>
            <div class="form-group">
...
</div><?php /**PATH C:\xampp\htdocs\shypdirect\resources\views/admin/Settings/PaymentSettings/gateway.blade.php ENDPATH**/ ?>