        ...
        <div class="container">
            <div class="row">
				...
				<div id='track_details_wrapper'>
					...
					<p class='track_headings'>A consignment was sent to you through <?php echo e($settings->site_name); ?> Logistics and Shipping Company  We recommend that you regularly keep track of your freight through our tracking system here. Feel free to contact us through our email in the contact page if you need any assistance of whatsoever kind.</p><br>

					<h3 class='track_subheadings' style='text-align: center;'>Your consignment details are as stated below</h3><br>


            <center><img src=" <?php echo e(asset('temp/custom2/tracking-search.png')); ?>" /></center>
      <center><h3><a href="<?php echo e(route('printnow', $courier->id)); ?>" class='btn btn-success'>Print Shipping Invoice</a></h3></center>
    ...
    <tr>
	  ...
	  <td><?php echo e($courier->percentage_complete); ?> % Complete</td>
		...
		<tr style="background-color: #db8e0e;">
                ...
                <td> <?php echo e($track->address); ?>, <?php echo e($track->city); ?> </td>  
           ...
           <?php if(isset($latesttrack->comment)): ?>
						...
						<td >Notice: <?php echo e($latesttrack->comment); ?></td>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.base1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shipping\resources\views/home/track-result.blade.php ENDPATH**/ ?>