...
<!-- send a single user email Modal-->
                ...
                <form method="POST" action="<?php echo e(route('edituser')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select type="text" class="form-control bg-<?php echo e($bg); ?>   text-<?php echo e($text); ?>"
                                name="qty"  required>
                                <option  value="<?php echo e($user->qty); ?>"><?php echo e($user->qty); ?></option>
 ...
 <!-- /Delete user Modal -->
<?php /**PATH /home/elitemaxpro/shypdirect.elitemaxpro.click/resources/views/admin/Users/users_actions.blade.php ENDPATH**/ ?>