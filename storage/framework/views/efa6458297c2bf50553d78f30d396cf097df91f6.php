                                    ...
                                    <div class="col-lg-6" style="color:#fff">
                                        <div class="righti-content-area">
                                            <div class="request-page-form-wrap">
                                                ...
                                                <form action="#" method="POST" class="request-page-form" novalidate="novalidate">
                                                    <div class="row">
                                                        <div class="col-md-6">
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shipping\resources\views/home/request-quote.blade.php ENDPATH**/ ?>