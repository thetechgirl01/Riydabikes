      ...
      <div class="row">
        ...
        <div class="col-md-12 col-sm-12">
            <div class="content-area padding-top-120 padding-bottom-90">
                ...
                Welcome to <a href="<?php echo e($settings->site_url); ?>"><?php echo e($settings->sit_name); ?></a>. This website is owned and operated by Transport Services Limited and <?php echo e($settings->site_name); ?>.
                ...
                Visitors to this website are bound by the following terms and conditions so please read these carefully before going on. For the purposes of these terms and conditions, “this website” means the following parts of the <a href="https://airproexpress.com/">https://airproexpress.com/</a>.
                <ul>
                ...
                If you wish to provide a hypertext or other link to this website, please email the <u><a href="mailto:support@airproexpress.com">Webmaster</a></u> and we will consider your request. It is our decision as to whether we agree to your request and we do not have to do so.
                <ul>
                ...
                If you have a question or complaint about this website, please <u><a href="mailto:support@airproexpress.com">contact the <?php echo e($settings->site_name); ?> webmaster</a></u>.
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shipping\resources\views/home/terms.blade.php ENDPATH**/ ?>