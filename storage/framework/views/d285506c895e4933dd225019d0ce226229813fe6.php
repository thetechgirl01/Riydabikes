<div class="row">
    ...
    <div class="col-md-12">
        <form action="<?php echo e(route('updateemailpreference')); ?>" method="POST" >
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /home/u215313542/domains/remedycodes.info/public_html/tracking1/resources/views/admin/Settings/AppSettings/email.blade.php ENDPATH**/ ?>