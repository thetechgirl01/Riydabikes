...
} elseif ($_instance->childHasBeenRendered('4pQQFQL')) {
    $componentId = $_instance->getRenderedChildComponentId('4pQQFQL');
    $componentTag = $_instance->getRenderedChildComponentTagName('4pQQFQL');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4pQQFQL');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('4pQQFQL', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH C:\xampp\htdocs\shyp\resources\views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>