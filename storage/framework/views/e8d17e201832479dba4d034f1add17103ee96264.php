...
} elseif ($_instance->childHasBeenRendered('RnntLTw')) {
    $componentId = $_instance->getRenderedChildComponentId('RnntLTw');
    $componentTag = $_instance->getRenderedChildComponentTagName('RnntLTw');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RnntLTw');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('RnntLTw', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215313542/domains/remedycodes.site/public_html/pro/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>