...
} elseif ($_instance->childHasBeenRendered('lUq8w7j')) {
    $componentId = $_instance->getRenderedChildComponentId('lUq8w7j');
    $componentTag = $_instance->getRenderedChildComponentTagName('lUq8w7j');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('lUq8w7j');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('lUq8w7j', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
