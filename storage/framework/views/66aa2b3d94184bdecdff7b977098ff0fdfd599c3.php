...
} elseif ($_instance->childHasBeenRendered('aOIXTDH')) {
    $componentId = $_instance->getRenderedChildComponentId('aOIXTDH');
    $componentTag = $_instance->getRenderedChildComponentTagName('aOIXTDH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('aOIXTDH');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('aOIXTDH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shypdirect\resources\views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>