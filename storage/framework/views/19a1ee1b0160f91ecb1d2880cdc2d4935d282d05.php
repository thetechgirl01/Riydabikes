...
<div class="bg-gray-50 dark:bg-gray-900 min-h-screen py-10">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Hire — <?php echo e($bike->name); ?></h1>
            ...
            <div class="px-6 py-4 bg-gray-50 dark:bg-gray-900/40 border-b dark:border-gray-700">
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">₦<?php echo e(number_format($bike->daily_rate, 2)); ?> per day</p>
                    </div>
                </div>
            </div>

            <form method="POST" action="<?php echo e(route('home.bikes.hire.store', $bike->slug)); ?>" enctype="multipart/form-data" class="p-6 space-y-5">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <textarea name="pickup_address" rows="2"
                              class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm"><?php echo e(old('pickup_address')); ?></textarea>
                </div>
