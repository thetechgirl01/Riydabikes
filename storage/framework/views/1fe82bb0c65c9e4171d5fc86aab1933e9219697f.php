...
} elseif ($_instance->childHasBeenRendered('BB83sSf')) {
    $componentId = $_instance->getRenderedChildComponentId('BB83sSf');
    $componentTag = $_instance->getRenderedChildComponentTagName('BB83sSf');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('BB83sSf');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('BB83sSf', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH /home/u215313542/domains/remedycodes.info/public_html/resources/views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>