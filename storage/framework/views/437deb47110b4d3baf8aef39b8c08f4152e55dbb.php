    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-center h-20 lg:relative desktop-nav-container">
            ...
            <div class="hidden lg:flex lg:items-center desktop-left-links">
                ...
                <a href="<?php echo e(route('home.shipments.create')); ?>" class="nav-link text-white hover:text-[#FFD600] px-3 py-2 text-sm font-medium transition-colors relative group">
                    Book Delivery
                    <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-[#FFD600] transition-all duration-300 group-hover:w-full"></span>
                </a>
                ...
                <a href="<?php echo e(route('home.bikes.index')); ?>" class="nav-link text-white hover:text-[#FFD600] px-3 py-2 text-sm font-medium transition-colors relative group">
                    Rent / Buy Bikes
                    <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-[#FFD600] transition-all duration-300 group-hover:w-full"></span>
                </a>
            </div>
        ...
        <div x-show="mobileMenuOpen"
            ...
            <div class="px-4 py-6 space-y-2">
                ...
                <a href="<?php echo e(route('home.shipments.create')); ?>" class="block px-3 py-2 text-gray-300 hover:bg-[#800020] hover:text-[#FFD600] rounded-lg transition-colors">Book Delivery</a>
                ...
                <a href="<?php echo e(route('home.bikes.index')); ?>" class="block px-3 py-2 text-gray-300 hover:bg-[#800020] hover:text-[#FFD600] rounded-lg transition-colors">Rent / Buy Bikes</a>
