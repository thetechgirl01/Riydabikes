...
<div class="sidebar sidebar-style-2" data-background-color="{{ Auth('admin')->User()->dashboard_style }}">
    ...
    <div class="collapse" id="bike-menu">
        <ul class="nav nav-collapse">
            <li><a href="{{ route('admin.bikes.index') }}"><span class="sub-item">Manage Bikes</span></a></li>
            <li><a href="{{ route('admin.bikes.purchases') }}"><span class="sub-item">Purchases</span></a></li>
            <li><a href="{{ route('admin.bikes.rentals') }}"><span class="sub-item">Rentals</span></a></li>
        </ul>
    </div>
</li>
...
<li class="nav-item {{ request()->routeIs('admin.pricing.index') ? 'active' : '' }} {{ request()->routeIs('admin.pricing.create') ? 'active' : '' }} {{ request()->routeIs('admin.pricing.edit') ? 'active' : '' }} {{ request()->routeIs('admin.pricing.settings') ? 'active' : '' }}">
    ...
    <div class="collapse" id="pricing-menu">
        <ul class="nav nav-collapse">
            <li><a href="{{ route('admin.pricing.index') }}"><span class="sub-item">Pricing Rules</span></a></li>
            <li><a href="{{ route('admin.pricing.settings') }}"><span class="sub-item">Pricing Settings</span></a></li>
        </ul>
    </div>
</li>
                    ...
                    {{-- <li
                        class="nav-item {{ request()->routeIs('admin.shipment.deposits') ? 'active' : '' }} {{ request()->routeIs('viewdepositimage') ? 'active' : '' }} {{ request()->routeIs('mdeposits') ? 'active' : '' }}">
                        <a href="{{route('admin.shipment.deposits')}}">
