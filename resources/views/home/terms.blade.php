      ...
      <div class="row">
        ...
        <div class="col-md-12 col-sm-12">
            <div class="content-area padding-top-120 padding-bottom-90">
                ...
                Welcome to <a href="{{ $settings->site_address }}">{{ $settings->sit_name }}</a>. This website is owned and operated by Transport Services Limited and {{$settings->site_name}}.
                ...
                Visitors to this website are bound by the following terms and conditions so please read these carefully before going on. For the purposes of these terms and conditions, “this website” means the following parts of the <a href="{{$settings->site_url}}">{{$settings->site_name}}</a>.
                <ul>
                    <li>This website contains material including text, photographs and other images and sound, which is protected by copyright and/or other intellectual property rights. All copyright and other intellectual property rights in this material are either owned by {{$settings->site_name}} or have been licensed to it by the owner(s) of those rights so that it can use this material as part of this website.</li>
                    <li>This website also contains trade marks, including the mark {{$settings->site_name}}” and the {{$settings->site_name}} logo. All trade marks included on this website belong to {{$settings->site_name}} or have been licensed to it by the owner(s) of those trade marks for use on this website.</li>
                </ul>
                ...
                If you wish to provide a hypertext or other link to this website, please email the <u><a href="mailto:{{$settings->contact_email}}">Webmaster</a></u> and we will consider your request. It is our decision as to whether we agree to your request and we do not have to do so.
                <ul>
                    <li>{{$settings->site_name}} may change the terms and conditions and disclaimer set out above from time to time. By browsing this website you are accepting that you are bound by the current terms and conditions and disclaimer and so you should check these each time you revisit the site.</li>
                </ul>
                ...
                <ul>
                    <li>{{$settings->site_name}} may change the format and content of this website at any time.</li>
                    <li>{{$settings->site_name}} may suspend the operation of this website for support or maintenance work, in order to update the content or for any other reason.</li>
                    <li>{{$settings->site_name}} reserves the right to terminate access to this website at any time and without notice.</li>
                </ul>
                <strong>Complaints Procedure</strong>

                If you have a question or complaint about this website, please <u><a href="mailto:{{$settings->contact_email}}">contact the {{$settings->site_name}} webmaster</a></u>.
