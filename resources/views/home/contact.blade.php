...
@section('title', 'Contact RydaBikes')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            ...
            <div class="group bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 p-6 text-center border border-gray-100 hover:border-[#800020]/20">
                ...
                <a href="mailto:{{$settings->contact_email}}" class="text-lg font-semibold text-[#800020] hover:underline">{{$settings->contact_email}}</a>
            </div>
            ...
            <div class="group bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 p-6 text-center border border-gray-100 hover:border-[#800020]/20">
                ...
                <p class="text-md font-medium text-gray-800">{{ $settings->locations ?? 'Lagos, Nigeria' }}</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div class="bg-white rounded-2xl shadow-md p-6 md:p-8">
                ...
                <form method="post" action="{{ route('enquiry') }}" class="space-y-5">
                    @csrf
                ...
                <div class="bg-white rounded-2xl shadow-md overflow-hidden">
                    ...
                    <div class="p-5">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <p class="text-gray-800 font-medium">{{ $settings->site_name }}</p>
                                <p class="text-gray-500 text-sm">{{ $settings->locations ?? 'Lagos, Nigeria' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
