                        ...
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                            ...
                            <div class="flex flex-col">
                                <div class="flex items-center px-4 py-2 bg-white/20 backdrop-filter backdrop-blur-sm rounded-lg mb-2">
                                    ...
                                    <div class="ml-2 px-2 py-0.5 rounded-full bg-{{ $courier->status === 'Delivered' ? 'green' : ($courier->status === 'Custom Hold' ? 'amber' : 'blue') }}-600 text-white text-sm font-medium">
                                        {{ $courier->status }}
                                    </div>
                                </div>
                                {{-- <div class="flex items-center text-white text-sm">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 opacity-80" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                                    <span class="opacity-90">Last Updated: {{ \Carbon\Carbon::parse($tracks->sortByDesc('created_at')->first()->created_at ?? $courier->updated_at)->format('M d, Y - h:i A') }}</span>
                                </div> --}}
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <div class="space-y-3 bg-primary-50/60 p-4 rounded-lg border border-primary-100">
                                ...
                                <div class="space-y-2 text-sm">
                                    <div class="flex items-center">
                                        ...
                                        <span class="font-medium text-gray-800">{{$courier->sname}}</span>
                                    </div>
                                    <div class="flex items-start">
                                        ...
                                        <span class="font-medium text-gray-700">{{$courier->saddress}}</span>
                                    </div>
                                    <!--<div class="flex items-center">-->
                                    ...
                                    <!--    <span class="font-medium text-gray-700">{{$courier->sphone ?? 'N/A'}}</span>-->
                                    <!--</div>-->
                                </div>
                            </div>
                            ...
                            <div class="space-y-3 bg-primary-50/60 p-4 rounded-lg border border-primary-100">
                                ...
                                <div class="space-y-2 text-sm">
                                    ...
                                    <div class="flex items-start">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-500 mr-2 flex-shrink-0 mt-0.5" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
                                        <span class="font-medium text-gray-700">{{$courier->address}}</span>
                                    </div>
                                    <div class="flex items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-500 mr-2 flex-shrink-0" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
                                        <span class="font-medium text-gray-700">{{$courier->phone}}</span>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <span class="font-medium text-gray-700">{{$courier->email}}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-3 bg-primary-50/60 p-4 rounded-lg border border-primary-100">
                                ...
                                <div class="space-y-2 text-sm">
                                    <div class="flex items-center">
                                        ...
                                        <span class="font-medium text-gray-800">{{ $courier->weight }} kg</span>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <span class="font-medium text-gray-800">{{ $courier->freight_type }}</span>
                                    </div>
                                    <div class="flex items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-500 mr-2 flex-shrink-0" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                                        <span class="text-gray-500 mr-2">Shipped:</span>
                                        <span class="font-medium text-gray-800">{{ \Carbon\Carbon::parse($courier->date_shipped)->format('M d, Y') }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-3 bg-primary-50/60 p-4 rounded-lg border border-primary-100">
                                ...
                                <div class="space-y-2 text-sm">
                                    <div class="flex items-center">
                                        ...
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $courier->status === 'Delivered' ? 'bg-green-100 text-green-800' : ($courier->status === 'Custom Hold' ? 'bg-amber-100 text-amber-800' : 'bg-blue-100 text-blue-800') }}">
                                            {{ $courier->status }}
                                        </span>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <span class="font-medium text-gray-800">{{ $courier->location }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="relative">
                                ...
                                <div class="hidden md:flex absolute top-1/2 left-0 w-full h-1 transform -translate-y-1/2 z-0">
                                    @for($i = 0; $i < $statusCount - 1; $i++)
                                        ...
                                        @endphp
                                        <div class="h-full flex-1 {{ $config['color'] }}"></div>
                                    @endfor
                                </div>
                                ...
                                <div class="md:hidden absolute top-0 left-8 h-full z-0 flex flex-col">
                                    @for($i = 0; $i < $statusCount - 1; $i++)
                                        @php
                                            ...
                                            $config = $statusConfig[$nextStatus->status] ?? ['color' => 'bg-primary-600'];
                                        @endphp
                                        <div class="w-1 flex-1 {{ $config['color'] }}"></div>
                                    @endfor
                                </div>

                                <!-- Progress Steps -->
                                <div class="flex flex-col md:flex-row justify-between relative z-10">
                                    @foreach($uniqueStatuses as $index => $track)
                                        @php
                                        ...
                                        <div class="flex md:block md:text-center {{ !$isLast ? 'mb-8 md:mb-0' : '' }}">
                                            <div class="flex-shrink-0 flex items-center justify-center w-16 h-16 md:mx-auto rounded-full {{ $config['color'] }} text-white shadow-lg border-4 border-white">
                                                {!! $config['icon'] !!}
                                            </div>
                                            <div class="ml-4 md:ml-0 md:mt-3">
                                                <h4 class="text-sm font-semibold text-gray-900">{{ $track->status }}</h4>
                                                <p class="text-xs text-gray-500 mt-1">{{ \Carbon\Carbon::parse($track->created_at)->format('M d, Y') }}</p>
                                                @if($track->address)
                                                    <p class="text-xs text-gray-400 mt-0.5">{{ $track->address }}</p>
                                                @endif
                                            </div>
                                        </div>
                                    @endforeach
                                    ...
                                    <div class="space-y-6">
                                        @foreach($tracks as $track)
                                            <div class="relative z-10 flex items-start">
                                                <div class="flex-shrink-0 flex items-center justify-center w-8 h-8 rounded-full {{ ($track->status === 'Delivered' || $track->status === 'Payment Received') ? 'bg-green-500' : ($track->status === 'Custom Hold' ? 'bg-amber-500' : 'bg-primary-600') }} text-white shadow-md border-2 border-white">
                                                    @if($track->status === 'Delivered' || $track->status === 'Payment Received')
                                                ...
                                                <div class="ml-4">
                                                    <div class="flex items-center">
                                                        <span class="text-xs font-medium text-gray-500">{{ \Carbon\Carbon::parse($track->created_at)->format('M d, Y - h:i A') }}</span>
                                                    </div>
                                                    <div class="mt-1">
                                                        <span class="px-2 py-1 text-xs font-semibold rounded-full {{ ($track->status === 'Delivered' || $track->status === 'Payment Received') ? 'bg-green-100 text-green-800' : ($track->status === 'Custom Hold' ? 'bg-amber-100 text-amber-800' : 'bg-blue-100 text-blue-800') }}">
                                                            {{ $track->status }}
                                                        </span>
                                                    </div>
                                                    <div class="mt-2 text-sm text-gray-700">
                                                        <p class="font-medium">{{ $track->city }}</p>
                                                        <p class="mt-1 text-gray-600">{{ $track->comment }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
                                    ...
                                    <div class="space-y-3">
                                        <div class="flex items-start">
                                            ...
                                            <div class="ml-2">
                                                ...
                                                <p class="text-xs text-gray-600 truncate">{{ $courier->saddress }}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex items-start">
                                            ...
                                            <div class="ml-2">
                                                ...
                                                <p class="text-xs text-gray-600 truncate">{{ $courier->location }}</p>
                                                @if($tracks->count() > 0)
                                                    @php
                                                        $latestTrack = $tracks->sortByDesc('created_at')->first();
                                                    @endphp
                                                    <p class="text-xs text-gray-500">
                                                        Updated: {{ \Carbon\Carbon::parse($latestTrack->created_at)->format('M d, Y - h:i A') }}
                                                    </p>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex items-start">
                                            ...
                                            <div class="ml-2">
                                                ...
                                                <p class="text-xs text-gray-600 truncate">{{ $courier->address }}</p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="flex flex-col md:flex-row">
                            ...
                            <div class="md:w-1/4 mb-6 md:mb-0 md:pr-6">
                                <div class="bg-gray-100 p-2 rounded-lg">
                                    <img src="{{ asset('public/' . $courier->photo) }}"
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="bg-gray-100 p-2 rounded-lg">
                                        <video controls class="w-full h-auto rounded-lg" preload="metadata">
                                            <source src="{{ asset('public/' . $courier->video) }}" type="video/mp4">
                            ...
                            <div class="md:w-{{ $courier->photo ? '3/4' : 'full' }}">
                                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <p class="text-green-600 font-semibold">{{ $courier->plan }}</p>
                                    </div>
                                    ...
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <p class="text-gray-700">{{ $courier->weight }} kg</p>
                                    </div>
                                    ...
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <p class="text-gray-700">{{ \Carbon\Carbon::parse($courier->date_shipped)->format('M d, Y - h:i A') }}</p>
                                    </div>
                                    ...
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <p class="text-gray-700">{{ \Carbon\Carbon::parse($courier->expected_delivery)->format('M d, Y - h:i A') }}</p>
                                    </div>
                                    ...
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <p class="text-gray-700">{{ $courier->freight_type }}</p>
                                    </div>
                                    ...
                                    <div class="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <p class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $courier->status === 'Delivered' ? 'bg-green-100 text-green-800' : ($courier->status === 'Custom Hold' ? 'bg-amber-100 text-amber-800' : 'bg-blue-100 text-blue-800') }}">
                                            {{ $courier->status }}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="mt-6 flex flex-wrap gap-3 justify-center md:justify-start">
                                    <a href="{{ route('printnow', $courier->id) }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-all">
                                    ...
                                    @if($courier->clearance_cost > 0 || $courier->cost > 0)
                                    <a href="{{ route('home.deposits', ['courier_id' => $courier->id]) }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all">
                                        ...
                                        Pay Clearance Fee ({{ number_format($courier->clearance_cost + $courier->cost, 2) }})
                                    </a>
                                    @endif
                                </div>
                            </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        setTimeout(function() {
            ...
            const originAddress = "{{ $courier->saddress }}";
            const currentAddress = "{{ $courier->location }}";
            const destinationAddress = "{{ $courier->address }}";
