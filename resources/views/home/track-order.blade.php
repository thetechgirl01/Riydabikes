                ...
                <div class="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
                    <div class="text-center lg:text-left mb-8">
                        ...
                        <p class="text-gray-600">
                            Here's the fastest way to check the status of your shipment. No need to call Customer Service – our online results give you real-time, detailed progress as your shipment speeds through the <strong class="text-primary-600">{{$settings->site_name}}</strong> network.
                        </p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('trackingresult') }}" class="space-y-6" x-data="{ trackingNumber: '' }">
                        @csrf
                        <div>
