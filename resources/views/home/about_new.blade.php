            ...
            <div class="space-y-6">
                <div>
                    ...
                    <h3 class="text-xl font-semibold text-primary-600 mb-6">
                        {{$settings->site_name}} is a privately owned, premier international freight forwarder, delivery and logistics service provider.
                    </h3>
                </div>
                
                <div class="space-y-4 text-gray-600 leading-relaxed">
                    <p>
                        {{$settings->site_name}} has extensive experience handling and delivery sensitive domestic and industrial products including consumer technology products like networking equipment, desktop and mobile computers, servers, cell phones and more.
                    </p>
                    
                    <p>
                        {{$settings->site_name}} delivers real-time, actionable information reliably and ensures optimal efficiency and on-time activities by utilizing advanced, custom software systems. Fully EDI capable, {{$settings->site_name}}'s systems interface with your trading partners to provide unprecedented product visibility throughout the entire supply chain.
                    </p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div class="space-y-6">
                ...
                <div class="space-y-4 text-gray-600 leading-relaxed">
                    <p>
                        At {{$settings->site_name}}, ensuring the safety of our customers, employees and our communities is our priority. We understand the importance of continuous training and are proud of our safety knowledge, experienced staff and ability to exceed industry standards year after year.
                    </p>
                    <p>
            ...
            <div class="space-y-6">
                ...
                <div class="space-y-4 text-gray-600 leading-relaxed">
                    <p>
                        At {{$settings->site_name}}, we offer industry-leading asset protection and security compliance programs. We understand that our customers may have important and unique needs related to homeland security regulatory compliance, high-risk products, or brand protection.
                    </p>
                    <p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="max-w-3xl mx-auto">
            ...
            <p class="text-xl text-primary-100 mb-8 leading-relaxed">
                Join thousands of satisfied customers who trust us with their logistics needs. Get started with {{$settings->site_name}} today.
            </p>
