...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="info-box">
                <p><strong>Amount:</strong> <span class="amount">{{ $user->currency }}{{ number_format($deposit->amount, 2) }}</span></p>
                <p><strong>Payment Method:</strong> {{ $deposit->payment_mode }}</p>
                <p><strong>Date:</strong> {{ $deposit->created_at->format('M d, Y H:i') }}</p>
